...
void app_main(void)
{
    ...
    //gpio_pwm_setup(PWM_GPIO, signal_index);
    Timer_Init(0, 1, 80, 1000);
    gpio_adc_setup(ADC_UNIT_2, 14);
    ...
    while (1)
    {
        ...
        printf("ADC = %u\n", adcValue);
        ledControl(21, 22, 23, adcValue, 700, 800);
        motor_control(adcValue, 700, 800, PWM_CHANNEL, PWM_RES_BITS);
        Timer_Delay(0, 1, 500);
    }
}